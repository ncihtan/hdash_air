...
def test_meta_file_id_checker():
    ...
    assert error_list[0].startswith("Invalid HTAN Participant ID:  HTA3_800_1")
    assert error_list[1].startswith("Invalid HTAN Participant ID:  nan")
    assert error_list[2].startswith("Invalid HTAN Participant ID:  HTA3_8005, ")
    ...
    assert error_list[1].startswith("Invalid HTAN Parent Biospecimen ID:  HTA3_8001")
